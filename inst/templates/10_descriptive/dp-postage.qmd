...
for (section in SECTIONS) {
  ...
  for (i in seq_along(pages)) {
    ...
    # Link relative to this document, which sits in the descriptive folder
    # beside graphs/. Quarto rewrites an absolute path into a broken relative
    # one and then cannot embed the image.
    link <- file.path("..", basename(dirname(dirname(file))), basename(dirname(file)), basename(file))
