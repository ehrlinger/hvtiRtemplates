...
set_path <- function(kind, file) {
  dir <- file.path(hvtiRutilities::study_dir(kind, .root), paste0(ENDPOINT, "-", TYPE))
...
# that refreshes it. Alternatively, set ANALYSIS_SET to NULL and select a
# registered DATASET ("study" for the whole built cohort).
