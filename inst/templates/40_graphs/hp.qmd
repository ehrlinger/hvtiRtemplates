...
# EDIT: upstream fit and actuarial estimate to plot.
FIT_NAME <- "deterministic"
KM_NAME <- "overall"

# Table horizons and curve limit.
# EDIT: reporting and plotting horizons.
years <- c(30 / 365.2425, 3 / 12, 6 / 12, 1:10)   # reporting: the table

t_max <- 3                                        # plotting: the curves

# Follow-up time and event columns.
# EDIT: time and event variables fitted in hz.
TIME  <- "iu_dead"
...
#
# the time and event variables your hz job fitted on. BOTH are needed:
