---
title: "Binary-treatment propensity model"
format:
  html:
    theme: cosmo
    toc: true
...
stacked imputations and the scored columns used by matching and weighting jobs.
...
TREATMENT <- "treatment"                   # EDIT: binary treatment column.
PREDICTORS <- c("age", "female")           # EDIT: pre-treatment covariates.
TREATMENT_LEVELS <- c("control", "treated") # EDIT: both accepted treatment values.
TREATED_LEVEL <- "treated"                 # EDIT: treated value.
