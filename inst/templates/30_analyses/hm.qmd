...
if (!is.null(.cur)) {
  ...
  if (length(.hits)) {
    ...
    .msg <- paste0(
      ...
      "marker and delete it; the draft banner goes when the last one does.\n",
      "To make an unfinished job stop instead, as a final render should, set ",
      "HVTI_TEMPLATE_STRICT to 1, true or yes."
    )
