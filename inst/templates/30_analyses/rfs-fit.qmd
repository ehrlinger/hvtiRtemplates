---
title: "Random forest survival: fit"
...
#| label: read
d <- read_built()
.outcomes <- intersect(c(TIME, STATUS), PREDICTORS)
if (length(.outcomes)) {
  stop("Do not include outcome variable(s) in PREDICTORS: ", paste(.outcomes, collapse = ", "), ".", call. = FALSE)
}
