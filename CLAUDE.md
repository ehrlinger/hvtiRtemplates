...
[`AGENTS.md`](https://ehrlinger.github.io/hvtiRtemplates/AGENTS.md),
...
(`/codemap hvtiRtemplates`). If the codemap looks stale, say so and
...
it, then orient from the repo itself — `NAMESPACE` exports, `R/`,
`inst/templates/README.md` and the templates themselves — before
editing.
