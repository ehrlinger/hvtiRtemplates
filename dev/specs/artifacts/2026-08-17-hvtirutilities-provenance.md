...
test_that("the package's own R/ directory is pure", {
  # pkgload sets this to the installed or loaded package root.
  r_dir <- system.file("..", "R", package = "hvtiRutilities")
  skip_if_not(dir.exists(r_dir), "source R/ not available from an install")
...
Plan: `dev/specs/artifacts/2026-08-17-hvtirutilities-provenance.md`
