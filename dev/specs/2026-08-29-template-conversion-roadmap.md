...
| prefix | status | ordinal | breadth | R exemplars | blocked on |
|---|---|---|---|---|---|
| `ac` | shipped | 03.01 | 756 | 16 | — |
| `cd` | queued | — | 202 | 6 | — |
| `hz` | shipped | 03.02 | 581 | 5 | — |
| `nd` | queued | — | 244 | 3 | — |
...
| prefix | status | ordinal | breadth | R exemplars | blocked on |
|---|---|---|---|---|---|
| `bd` | queued | — | 1134 | 15 | hvtiRdatabuild |
| `dt` | queued | — | 512 | 0 | hvtiRdatabuild |
| `vars` | queued | — | 959 | 2 | hvtiRdatabuild |
